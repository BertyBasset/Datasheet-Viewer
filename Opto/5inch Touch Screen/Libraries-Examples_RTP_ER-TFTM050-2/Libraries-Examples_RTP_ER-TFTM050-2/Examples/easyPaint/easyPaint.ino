  ...
  if (tft.touchDetect()){//easy!
      ...
      if (ty >= 0 && ty <= 55){ //interface area
        ...
        if (choosenColor != 0) {
          ...
          tft.fillCircle(tx,ty,3,choosenColor);
        }
      }
  }
}
